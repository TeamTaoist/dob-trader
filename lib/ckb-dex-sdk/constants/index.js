export const CKB_UNIT = BigInt(100000000);
export const MAX_FEE = BigInt(20000000);
...
export const getJoyIDLockScript = (isMainnet) => (isMainnet ? MainnetInfo.JoyIDLockScript : TestnetInfo.JoyIDLockScript);
export const getJoyIDCellDep = (isMainnet) => (isMainnet ? MainnetInfo.JoyIDLockDep : TestnetInfo.JoyIDLockDep);
export const getCotaTypeScript = (isMainnet) => (isMainnet ? MainnetInfo.CotaTypeScript : TestnetInfo.CotaTypeScript);
export const getCotaCellDep = (isMainnet) => (isMainnet ? MainnetInfo.CotaTypeDep : TestnetInfo.CotaTypeDep);
export const getDexLockScript = (isMainnet) => (isMainnet ? MainnetInfo.DexLockScript : TestnetInfo.DexLockScript);
export const getDexCellDep = (isMainnet) => (isMainnet ? MainnetInfo.DexLockDep : TestnetInfo.DexLockDep);
export const getXudtTypeScript = (isMainnet) => (isMainnet ? MainnetInfo.XUDTTypeScript : TestnetInfo.XUDTTypeScript);
export const getXudtDep = (isMainnet) => (isMainnet ? MainnetInfo.XUDTTypeDep : TestnetInfo.XUDTTypeDep);
export const getSudtTypeScript = (isMainnet) => (isMainnet ? MainnetInfo.SUDTTypeScript : TestnetInfo.SUDTTypeScript);
export const getSudtDep = (isMainnet) => (isMainnet ? MainnetInfo.SUDTTypeDep : TestnetInfo.SUDTTypeDep);
export const getSporeTypeScript = (isMainnet) => (isMainnet ? MainnetInfo.SporeTypeScript : TestnetInfo.SporeTypeScript);
export const getSporeDep = (isMainnet) => (isMainnet ? MainnetInfo.SporeTypeDep : TestnetInfo.SporeTypeDep);
export const getMNftTypeScript = (isMainnet) => (isMainnet ? MainnetInfo.MNftTypeScript : TestnetInfo.MNftTypeScript);
export const getMNftDep = (isMainnet) => (isMainnet ? MainnetInfo.MNftTypeDep : TestnetInfo.MNftTypeDep);
